...
namespace RSSAIzer.Backend.Migrations
{
    ...
    [Migration("20251216215341_RemoveMaxToken")]
    partial class RemoveMaxToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.DigestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.DigestStepEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.DigestSummaryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.FeedEntity", b =>
                {
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.PostSummaryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.SettingsEntity", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Infrastructure.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.AiProcessingStepEntity", b =>
                {
                    b.HasBaseType("RSSAIzer.Backend.Db.DigestStepEntity");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.ErrorStepEntity", b =>
                {
                    b.HasBaseType("RSSAIzer.Backend.Db.DigestStepEntity");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.RssReadingFinishedStepEntity", b =>
                {
                    b.HasBaseType("RSSAIzer.Backend.Db.DigestStepEntity");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.RssReadingStartedStepEntity", b =>
                {
                    b.HasBaseType("RSSAIzer.Backend.Db.DigestStepEntity");
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.SimpleStepEntity", b =>
                {
                    b.HasBaseType("RSSAIzer.Backend.Db.DigestStepEntity");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("RSSAIzer.Backend.Infrastructure.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.DigestEntity", b =>
                {
                    b.HasOne("RSSAIzer.Backend.Infrastructure.ApplicationUser", "UserNav")
                        .WithMany()
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.DigestSummaryEntity", b =>
                {
                    b.HasOne("RSSAIzer.Backend.Db.DigestEntity", "DigestNav")
                        .WithOne("SummaryNav")
                        .HasForeignKey("RSSAIzer.Backend.Db.DigestSummaryEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RSSAIzer.Backend.Db.PostSummaryEntity", b =>
                {
                    ...
                    b.HasOne("RSSAIzer.Backend.Db.FeedEntity", "FeedNav")
                        .WithMany()
